...
JHTML::script('main.js', 'administrator/components/com_xcal/add/js/');
...
class JFormFieldModal_coordinate extends JFormField
{
	...
	{	
		...
		$html= '
			...
			<label>Coordinate: </label><input name="'.$this->name.'" id="jform_coordinate" type="text" size="41" value="'.$def.'"/>
		';
