 ...
 * event Table class
 */
class XcalTableevent extends JTable
{
	/**
	 * Constructor
	 *
	...
	{
		parent::__construct('#__xcal_events', 'id', $db);
	}
	...
	function upload ($file){
		...
		if($filename!=''){
			...
			$dest =  JPATH_SITE. DS ."images".DS."xcal_doc".DS.$filename;
