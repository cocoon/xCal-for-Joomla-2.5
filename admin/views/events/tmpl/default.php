	...
	<table class="adminlist">
		<thead>
			<tr>
				...
				<?php echo JHtml::_('grid.sort',  'COM_XCAL_EVENTS_TITLE', 'a.title', $listDirn, $listOrder); ?>
				</th>
				<th class='left'>
				<?php echo JHtml::_('grid.sort',  'COM_XCAL_EVENTS_USERNAME', 'a.username', $listDirn, $listOrder); ?>
				</th>
				<th class='left'>
				<?php echo JHtml::_('grid.sort',  'COM_XCAL_EVENTS_CATID', 'category', $listDirn, $listOrder); ?>
				</th>
				<th class='left' width="150px">
				<?php echo JHtml::_('grid.sort',  'COM_XCAL_EVENTS_IMAGE', 'a.image', $listDirn, $listOrder); ?>
				</th>
				<th class='left'>
				<?php echo JHtml::_('grid.sort',  'COM_XCAL_EVENTS_NEXT', 'a.next', $listDirn, $listOrder); ?>
				</th>
				<th class='left'>
				<?php echo JHtml::_('grid.sort',  'COM_XCAL_EVENTS_LUOGO', 'a.luogo', $listDirn, $listOrder); ?>
				</th>
		...
		<?php foreach ($this->items as $i => $item) :
			...
			<tr class="row<?php echo $i % 2; ?>">
				...
				<?php endif; ?>
				<?php if ($canEdit) : ?>
					<a href="<?php echo JRoute::_('index.php?option=com_xcal&task=event.edit&id='.(int) $item->id); ?>">
				...
				<td>
					<img style="max-height:150px; max-width:150px" src="../<?php echo $item->image; ?>" />
				</td>
				<td>
					<?php echo $item->next; ?>
				</td>
