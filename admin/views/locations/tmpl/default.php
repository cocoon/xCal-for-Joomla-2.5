...
<form action="<?php echo JRoute::_('index.php?option=com_xcal&view=events'); ?>" method="post" name="adminForm" id="adminForm">
	...
	<table class="adminlist">
		<thead>
			<tr>
				...
				<?php echo JHtml::_('grid.sort',  'COM_XCAL_LOCATIONS_NAME', 'a.name', $listDirn, $listOrder); ?>
				</th>
				<th class='left'>
				<?php echo JHtml::_('grid.sort',  'COM_XCAL_LOCATIONS_CITY', 'a.city', $listDirn, $listOrder); ?>
				</th>
				<th class='left' width="50%">
				<?php echo JHtml::_('grid.sort',  'COM_XCAL_LOCATIONS_ADDRESS', 'a.address', $listDirn, $listOrder); ?>
				</th>
		...
		<?php foreach ($this->items as $i => $item) :
			...
			<tr class="row<?php echo $i % 2; ?>">
				...
				<?php endif; ?>
				<?php if ($canEdit) : ?>
					<a href="<?php echo JRoute::_('index.php?option=com_xcal&task=location.edit&id='.(int) $item->id); ?>">
