...
<form action="<?php echo JRoute::_('index.php?option=com_xcal&view=categories'); ?>" method="post" name="adminForm" id="adminForm">
	...
	<table class="adminlist">
		<thead>
			<tr>
				...
				<?php echo JHtml::_('grid.sort',  'COM_XCAL_CATEGORIES_COLOR', 'a.color', $listDirn, $listOrder); ?>
				</th>

				<th class='left'>
				<?php echo JHtml::_('grid.sort',  'COM_XCAL_CATEGORIES_TITLE', 'a.title', $listDirn, $listOrder); ?>
				</th>
		...
		<?php foreach ($this->items as $i => $item) :
			...
			<tr class="row<?php echo $i % 2; ?>">
				...
				<td>
					<div style="witdh:50px; height:50px; background:<?php echo $item->color; ?>;"></div>
				</td>
				...
				<?php endif; ?>
				<?php if ($canEdit) : ?>
					<a href="<?php echo JRoute::_('index.php?option=com_xcal&task=category.edit&id='.(int) $item->id); ?>">
