 ...
 */
class XcalViewCategories extends JView
{
	protected $items;
	...
	protected function addToolbar()
	{
		...
		JToolBarHelper::title(JText::_('COM_XCAL_TITLE_CATEGORIES'), 'categories.png');

        //Check if the form exists before showing the add/edit buttons
        $formPath = JPATH_COMPONENT_ADMINISTRATOR.DS.'views'.DS.'category';
		...
		if ($canDo->get('core.admin')) {
			JToolBarHelper::preferences('com_xcal');
		}
